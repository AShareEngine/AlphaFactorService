...
def create_factor_backtest_job(payload: FactorBacktestJobCreate) -> FactorBacktestJobOut:
    ...
    configuration = {
        ...
        "exclude_limit_paused": payload.exclude_limit_paused,
        "exclude_st": payload.exclude_st,
        "exclude_new_stocks": payload.exclude_new_stocks,
        "minimum_listing_trading_days": 60,
        "exclude_delisting": payload.exclude_delisting,
        "exclude_bse": payload.exclude_bse,
